  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between rounded-md border bg-muted/30 p-2 text-xs">
        ...
        <ConfidenceBadge score={confidence} className="" showIcon />
      </div>
      {latestSnapshot ? (
...
export function ActiveBatchesSection({ batches }: { batches: InventoryBatch[] }) {
  if (batches.length === 0) {
    return <p className="text-xs text-muted-foreground">No active batches.</p>;
  }
  return (
...
// =====================  Legacy Card wrapper (still used by some callers)  =====================
  ...
  return (
    <div className="flex flex-col gap-4">
      <Card>
        ...
        <CardContent>
          <ProductInfoSection product={product} category={category} supplier={supplier} />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <BranchStockSection store={store} prediction={prediction} snapshots={snapshots} />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <FinancialsSection product={product} prediction={prediction} />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <DatesSection prediction={prediction} batches={batches} />
        </CardContent>
      </Card>
